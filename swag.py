...
def swag_main():
    ...
    Layer_1_Act_X_1 = Dense(hidden_dimention, activation='x1')(in_)
    Layer_1_Act_X_2 = Dense(hidden_dimention, activation='x2')(in_)
    Layer_1_Act_X_3 = Dense(hidden_dimention, activation='x3')(in_)
    ...
    Layer_1_Act_X_4=Dense(hidden_dimention, activation='x4')(in_)

    Layer_1_Act_X_5=Dense(hidden_dimention, activation='x5')(in_)

    Layer_1_Act_X_6=Dense(hidden_dimention, activation='x6')(in_)

    Layer_1_Act_X_7=Dense(hidden_dimention, activation='x7')(in_)

    Layer_1_Act_X_8=Dense(hidden_dimention, activation='x8')(in_)
    ...
    Layer_2_Act_X_2=Dense(hidden_dimention, activation='x2')(Concatenate_First_Layer)
    Layer_3_Act_X_2=Dense(hidden_dimention, activation='x2')(Layer_2_Act_X_2)
    Layer_4_Act_X_2=Dense(hidden_dimention, activation='x2')(Layer_3_Act_X_2)
    Layer_5_Act_X_2=Dense(hidden_dimention, activation='x2')(Layer_4_Act_X_2)
    Layer_6_Act_X_2=Dense(hidden_dimention, activation='x2')(Layer_5_Act_X_2)
    Layer_8_Act_X_2=Dense(hidden_dimention, activation='x2')(Layer_6_Act_X_2)
